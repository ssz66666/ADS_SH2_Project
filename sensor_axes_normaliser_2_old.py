...
#             # features_pamap.to_pickle('pamap_features.pkl')
    ...
    data_remapped = preprocess.remap_subject_ids([data_mhealth, data_pamap])
    data = pd.concat(data_remapped)
    data.to_pickle('data.pkl')
    data = axes_normaliser_2(data, ['chest'], ['acc', 'gyro'])
    data.to_pickle('fully_reformatted_telephone_compare.pkl')
#
